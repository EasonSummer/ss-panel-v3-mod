...
class Config
{
    ...
    public static function getSupportParam($type)
    {
        switch ($type) {
            case 'obfs':
                $list = array('http_simple', 'http_post',
                            'tls1.2_ticket_auth', 'tls1.2_ticket_fastauth',
                            'simple_obfs_http', 'simple_obfs_tls');
                return $list;
            case 'protocol':
                $list = array('origin', 'auth_aes128_sha1', 'auth_aes128_md5', 'auth_chain_a', 'auth_chain_b');
                return $list;
            ...
            case 'ss_obfs':
                ...
                return $list;
            default:
                $list = array('chacha20', 'chacha20-ietf', 'none','aes-256-gcm', 'chacha20-ietf-poly1305', 'xchacha20-ietf-poly1305');
                return $list;
        }
    }
}
